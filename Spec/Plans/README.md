...
| [Enter-Call-Details-Implementation-Plan.md](Enter-Call-Details-Implementation-Plan.md) | Implementation plan for UC-Enter-Call-Details and its sub-use cases (issue #23) |
